      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="prose prose-zinc prose-sm md:prose-base max-w-none text-zinc-600 space-y-8 font-medium">
            <section>
              <h2 className="text-sm font-bold text-zinc-900 mb-4 uppercase">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-sm font-bold text-zinc-900 mb-4 uppercase">2. Services Provided</h2>
              <p>
            ...
            <section>
              <h2 className="text-sm font-bold text-zinc-900 mb-4 uppercase">3. Quotations and Estimates</h2>
              <p>
            ...
            <section>
              <h2 className="text-sm font-bold text-zinc-900 mb-4 uppercase">4. User Obligations</h2>
            ...
            <section>
              <h2 className="text-sm font-bold text-zinc-900 mb-4 uppercase">5. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-sm font-bold text-zinc-900 mb-4 uppercase">6. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-sm font-bold text-zinc-900 mb-4 uppercase">8. Contact Us</h2>
              <p>
