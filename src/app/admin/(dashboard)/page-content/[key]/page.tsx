...
import FeaturedServicesForm from "../../../_components/pageContent/FeaturedServicesForm";
        ...
        {(() => {
          switch (key) {
            ...
            case "featured-services":
              return <FeaturedServicesForm content={content as PageContentMap["featured-services"]} />;
            case "finance-banner":
