...
export default function ProjectCaseStudy({
  ...
  project: Project;
  /** This page's own wording for the section; blanks keep the project's. */
  labels?: {
    eyebrow?: string;
    heading?: string;
    text?: string;
        ...
        <div className="grid items-center gap-6 rounded-xl bg-[#101314] p-3 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="px-3 pb-5 lg:col-span-7 lg:px-2 lg:py-6">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              >
                {labels.button || "I want results like this"}
              ...
              >
                {labels.link || "See the full project"}
              </Link>
            </div>
          </div>
        </div>
